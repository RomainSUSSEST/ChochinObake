...
/// <summary>
/// Classe mère des mondes, permet de générer les joueurs, le background, les obstacles et l'arrivée.
/// 
...
public class World : MonoBehaviour
{
    ...
    [SerializeField] private GameObject EndMapPrefab;
    ...
    [SerializeField] private float DestroyElementsMargin = 5f;
    ...
    /// Lance la fin de la partie une fois la musique terminée.
    /// </summary>
    /// <returns></returns>
